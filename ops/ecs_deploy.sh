...
ecs_deploy()
{
    ...
    echo 'Listing images...'
    ECR_IMAGE_DIGEST=$(aws ecr list-images --repository-name provide/privacy | jq '.imageIds[0].imageDigest')
    ...
    sed -E "s/privacy:[a-zA-Z0-9\.-]+/privacy:${buildRef}/g" "./${DEFINITION_FILE}" > "./${MUNGED_FILE}"
